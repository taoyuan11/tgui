...
fn canvas_scroll_panel() -> Column<()> {
    ...
    .child(
        Stack::new()
            ...
            .scrollbar_insets(Insets::all(10.0))
                ...
                Stack::new()
                    ...
                    .child(
                        Text::new("Large canvas")
                            ...
                            .offset(tgui::Point { x: 28.0, y: 24.0 }),
                    )
                    .child(
                        Stack::new()
                            .size(220.0, 120.0)
                            .offset(tgui::Point { x: 560.0, y: 140.0 })
                    ...
                    .child(
                        Stack::new()
                            .size(280.0, 160.0)
                            .offset(tgui::Point { x: 120.0, y: 480.0 })
                    ...
                    .child(
                        Stack::new()
                            .size(180.0, 180.0)
                            .offset(tgui::Point { x: 670.0, y: 520.0 })
