...
fn window_button_style(ctx: &StyleContext<'_>, background: Color) -> ButtonStyle {
    ButtonStyle {
...
impl AppVm {
    ...
    fn resize_grip(direction: WindowResizeDirection, cursor: CursorStyle) -> Element<Self> {
        ...
        let grip = Stack::new()
            .position_absolute()
            .style_full(|ctx| surface_style(ctx, Some(Color::hexa(0x00000000)), Dp::ZERO, None))
            .cursor(cursor)
    ...
    fn window_button(
        ...
        Button::new(label)
            ...
            .style_full(move |ctx| {
                let mut style = window_button_style(ctx, background);
                style.foreground = stateful(Color::hexa(0xF8FAFCFF).into());
                style.text_style = text_style(ctx, sp(15.0), Color::hexa(0xF8FAFCFF)).typography;
                style
            })
            .on_click(command)
    }
        ...
        Flex::new(Axis::Horizontal)
            ...
            .child(
                Text::new("tgui frameless")
                    .style_full(|ctx| text_style(ctx, sp(15.0), Color::hexa(0xF8FAFCFF)))
                    .grow(1.0),
            )
    ...
    fn modal_title_bar(&self) -> Element<Self> {
        Flex::new(Axis::Horizontal)
            ...
            .gap(dp(8.0))
            .style_full(|ctx| surface_style(ctx, Some(Color::hexa(0x1A2440FF)), Dp::ZERO, None))
            .on_click(Command::new_with_context(|_: &mut Self, context| {
                context.window().drag_window();
            }))
            .child(
                Text::new("Confirm exit")
                    .style_full(|ctx| text_style(ctx, sp(14.0), Color::hexa(0xE2E8F0FF)))
                    .grow(1.0),
            )
            .child(Self::window_button(
                "x",
        ...
        Stack::new()
            ...
            .child(
                Flex::new(Axis::Vertical)
                    .size(pct(100.0), pct(100.0))
                    .style_full(|ctx| {
                        surface_style(ctx, Some(Color::hexa(0x0B1020FF)), dp(18.0), None)
                    })
                                ...
                                Flex::new(Axis::Vertical)
                                    ...
                                    .child(
                                        Text::new("Custom chrome")
                                            .style_full(|ctx| {
                                                text_style(ctx, sp(28.0), Color::hexa(0xF8FAFCFF))
                                            }),
                                    )
                                    .child(
                                        Text::new(
                                        ...
                                        .style_full(|ctx| {
                                            text_style(ctx, sp(16.0), Color::hexa(0xCBD5E1FF))
                                        }),
                                    )
                                    .child(
                                        Text::new(
                                        ...
                                        .style_full(|ctx| {
                                            text_style(ctx, sp(15.0), Color::hexa(0x93C5FDFF))
                                        }),
                                    )
                                    .child(
                                        Text::new(
                                        ...
                                        Button::new("Open modal confirmation")
                                            ...
                                            .style_full(|ctx| {
                                                ButtonStyle {
                                                    ...
                                                    padding_y: dp(10.0),
                                                    min_height: dp(42.0),
                                                    text_style: TextWidgetStyle::default_for_theme(
                                                        ctx.theme,
                                                    )
                                                    .typography,
                                                }
        ...
        Stack::new()
            ...
            .child(
                Flex::new(Axis::Vertical)
                    .size(pct(100.0), pct(100.0))
                    .style_full(|ctx| {
                        surface_style(ctx, Some(Color::hexa(0x101827FF)), dp(18.0), None)
                    })
                        ...
                        Flex::new(Axis::Vertical)
                            ...
                            .child(
                                Text::new("Exit the frameless demo?")
                                    .style_full(|ctx| {
                                        text_style(ctx, sp(24.0), Color::hexa(0xF8FAFCFF))
                                    }),
                            )
                            .child(
                                Text::new(
                                ...
                                .style_full(|ctx| {
                                    text_style(ctx, sp(15.0), Color::hexa(0xCBD5E1FF))
                                }),
                            )
                            .child(
                                Text::new(
                                ...
                                .style_full(|ctx| {
                                    text_style(ctx, sp(14.0), Color::hexa(0x93C5FDFF))
                                }),
                            )
                            .child(
                                Flex::new(Axis::Horizontal)
