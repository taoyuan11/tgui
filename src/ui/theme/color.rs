...
impl ColorScheme {
    pub fn light() -> Self {
        Self {
            background: Color::hexa(0xF5F5F5FF),
            on_background: Color::hexa(0x1F1F1FFF),
            ...
            on_surface_muted: Color::hexa(0x737373E0),
            ...
            outline_muted: Color::hexa(0xEDEDEDCC),
            focus_ring: Color::hexa(0x4096FFFF),
            selection: Color::hexa(0x0078D459),
            disabled: Color::hexa(0xF0F0F0FF),
            on_disabled: Color::hexa(0xBFBFBFFF),
    ...
    pub fn dark() -> Self {
        Self {
            background: Color::hexa(0x141414FF),
            on_background: Color::hexa(0xF5F5F5FF),
            surface: Color::hexa(0x1F1F1FFF),
            surface_low: Color::hexa(0x262626FF),
            surface_high: Color::hexa(0x303030FF),
            surface_overlay: Color::hexa(0x262626F2),
            on_surface: Color::hexa(0xF5F5F5FF),
            on_surface_muted: Color::hexa(0xA6A6A6D9),
            primary: Color::hexa(0x0078D4FF),
            on_primary: Color::hexa(0xFFFFFFFF),
            ...
            outline_muted: Color::hexa(0x595959A6),
            focus_ring: Color::hexa(0x69B1FFFF),
            selection: Color::hexa(0x0078D466),
            disabled: Color::hexa(0x303030FF),
            on_disabled: Color::hexa(0x8C8C8CFF),
