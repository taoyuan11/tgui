...
pub(crate) struct CollectContext<'a, 'b> {
    ...
    pub(crate) menu_open_states: &'a HashMap<WidgetId, bool>,
    pub(crate) menubar_active_states: &'a HashMap<u64, Option<usize>>,
    pub(crate) context_menu_anchor_states: &'a HashMap<WidgetId, Point>,
